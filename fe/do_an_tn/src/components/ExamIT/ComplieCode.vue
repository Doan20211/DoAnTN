<template>
  <div>
    <div class="border mb-2 " style="">
        <h1>Đề bài</h1>
        <div style="">
            <textarea name="" id="" cols="150" rows="10" v-model="thread" disabled></textarea>
        </div>
    </div>
    <div class="row">
      ...
      <div><Button @click="submit" class="btn btn-primary btn-large">Submit</Button></div>
...
export default {
  data() {
    return {
      thread: "Viết chương trình HelloWorld. \nInput: \nOutput: HelloWorld\n",
      requestBody: {
