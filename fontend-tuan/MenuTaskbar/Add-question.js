var q = [
    {'Q':'Cách viết "Hello World" trong  alert box?', 'A':2,'C':['msg("Hello World");','alert("Hello World");','alertBox("Hello World");'],'H':"Hint 1"},
    {'Q':'Cách tạo function trong JavaScript?', 'A':3,'C':['function:myFunction()','function = myFunction()','function myFunction()'],'H':"Hint 1"},
    {'Q':'Cách viết câu lệnh IF trong JavaScript?', 'A':1,'C':['if (i == 5)','if i = 5 then','if i == 5 then'],'H':"Hint 1"},
    {'Q':'Cách bắt đầu 1 vòng lặp FOR?', 'A':2,'C':['for (i = 0; i <= 5)','for (i = 0; i <= 5; i++)','for i = 1 to 5'],'H':"Hint 1"},
    {'Q':'Đâu là cách viết mảng trong JavaScript đúng?', 'A':3,'C':['var colors = "red", "green", "blue"','var colors = (1:"red", 2:"green", 3:"blue")','var colors = ["red", "green", "blue"]'],'H':"Hint 1"}
];
...
for( i; i< q.length; i++){
$($('#f-option').parent().find('label')).html(q[questionNo].C[i]);
}
